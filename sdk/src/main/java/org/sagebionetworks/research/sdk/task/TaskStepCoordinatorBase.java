...
public abstract class TaskStepCoordinatorBase implements TaskStepCoordinator {
    @NonNull
    private final String identifier;
    @Nullable
    private final TaskEntity info;
    @NonNull
    private final List<AsyncAction> asyncActions;

    public TaskStepCoordinatorBase(@NonNull String identifier, TaskEntity info) {
    ...
    public boolean equals(Object o) {
        ...
        TaskStepCoordinatorBase task = (TaskStepCoordinatorBase) o;
