...
import org.sagebionetworks.research.interfaces.task.Duration;
...
public interface AsyncAction {
    /**
     * A short string that uniquely identifies the asyncronous action within the taskStepCoordinator. The identifier is reproduced in
    ...
    /**
     * An identifier marking the step to start the action. If `null`, then the action will be started when the taskStepCoordinator is
     * started.
     *
     ...
     * taskStepCoordinator is stopped.
     *
     * @return step identifier, or null
     */
    @Nullable
